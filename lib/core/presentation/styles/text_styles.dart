...
abstract class TextStyles {
  ...
  static TextStyle f24(BuildContext context) => _mainStyle(context).copyWith(
  ...
  static TextStyle get coloredElevatedButton => const TextStyle(
        color: Colors.white,
        fontSize: Sizes.font16,
  ...
  static TextStyle cupertinoDialogAction(BuildContext context) =>
      f16SemiBold(context).copyWith(color: Colors.black);

  static TextStyle pinCodeTextStyle(BuildContext context) =>
      _mainStyle(context).copyWith(
        fontSize: Sizes.font24,
        color: Theme.of(context).textTheme.titleMedium!.color,
        fontWeight: FontStyles.fontWeightLight,
      );
}
